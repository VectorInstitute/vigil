...
// Fields are populated by loadObjects (generated by bpf2go in the full build).
type objects struct {
	Events             *ebpf.Map
	BlockedPaths       *ebpf.Map
	BlockedIPv4        *ebpf.Map
	TraceOpenat        *ebpf.Program
	TraceExecve        *ebpf.Program
	TraceConnect       *ebpf.Program
	LsmFileOpen        *ebpf.Program
	LsmSocketConnect   *ebpf.Program
	LsmBprmCheck       *ebpf.Program
}
